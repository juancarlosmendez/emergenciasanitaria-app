                      ...
                      <TouchableOpacity onPress={() => this.props.navigation.navigate('ModalViewEmergency', { 
                        ...
                        <View style={{padding:10,flexDirection:'column'}}>                          
                          <View style={{flex:1,flexDirection:'row'}}>
                            <View style={{flex:1}}>
                              <View style={{borderRadius:70,marginTop:4,width:10,height:10,backgroundColor:'#FF0000'}}></View>
                            </View>
                            <Text style={{color:'#FF0000',flex:19}}>{("Emergencia COVID-19").toUpperCase()}</Text>
                          </View>
                          <View style={{flex:1,flexDirection:'row'}}>
                            <View style={{flex:1}}></View>
                            <View style={{flex:19}}>
                              <Text style={{marginTop:4,marginBottom:0}}>
                                Por favor ayuden a este caballero que no tiene...                         
                              </Text>
                              <View style={{flex:1,flexDirection:'row',marginBottom:5,marginTop:5}}>                      
                                ...
                                <Text style={{color:'#333333,',flex:19}}>A. 9 de Octubre Cruce del parque diagonal al supermercado xyz y otra calle mas </Text>
                              </View>
                              <View style={{flex:1,flexDirection:'row'}}>                      
                                <Icon name="calendar" size={13} color="#333333" style={{marginTop:2,flex:1}}/>                         
                                <Text style={{color:'#333333,',flex:19}}>9 de Abril 2020 - 23:00</Text>
                              </View>
                            </View>
                          </View>
                        </View>
