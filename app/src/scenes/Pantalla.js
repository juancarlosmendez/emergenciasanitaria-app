...
constructor(props) {
    ...
    this.state = {
      ...
      actual_url:"",
      temp_url:"",
      home_url:"https://lynx-server.com/controlapp/poster.php",  //kind of not used
      js_at_loaded:'',
      list_commands:[],
            ...
            return (
              ...
              <View style={styles.header}>
                  <View style={styles.headerAction}>
                      <Icon2 name="ios-arrow-back" size={30} color="#EEEEEE" style={{marginTop:4,marginRight:12,marginLeft:12,marginBottom:5}}
              ...
              <View style={styles.fakeLoader}>
                  <ActivityIndicator size="large" color="#293A4E" style={{marginTop:this.state.fakeLoaderLoadingMarginTop}} />
              </View>
